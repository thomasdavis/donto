---
title: User Guide
description: Getting data in, querying, scopes, snapshots, and hypotheses
---
...
User-authored shapes live in Lean (see the [Lean Overview](/donto/lean/overview/)
and [Operator Guide](/donto/guides/operator-guide/)).
