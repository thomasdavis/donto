...
- **Functional requirements** — §8 (FR-001 through FR-020).
- **Architecture (component map, storage, APIs)** — §10.
- **Native query language requirements** — §11.
- **Language-evidence pilot** — §13.
- **Adapter requirements + initial backlog** — §14.
- **Review workbench** — §15.
- **Extraction pipeline** — §16.
- **Release builder** — §17.
- **Milestones M0–M9** — §18.
- **Agentic-coder task packets A–J** — §19.
- **API sketch** — §20.
- **Testing strategy** — §21.
...
Three documents informed the canonical PRD and remain on disk for
...
that contributors (human and agent) follow when changing donto.
